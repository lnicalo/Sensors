...
class BinOperationSuite extends FunSuite with ShouldMatchers {
  test("Bin operation") {
    val v = List((1.0,1), (2.0,2), (3.0,4), (4.0,None))
    val w = List((1.5,1), (2.5,3), (3.5,5), (4.5, None))
    val out = Signal.BinOperation(v, w)

    val test_out = Map(5 -> List((3.5,Some(4)), (4.0,None)),
  ...
  test("Bin operation - with same timestamps") {
    ...
    val test_out = Map(
      ...
      7 -> List((3.5,Some(4)), (4.0,Some(6)), (5.0,None)),
  ...
  test("Bin operation - with duplicates") {
    ...
    val out = Signal.BinOperation(v, filter)
    val test_out = Map(
      false -> List((1.9,Some(1)), (2.0,Some(2)), (3.0,Some(4)), (3.0,None)),
  ...
  test("Bin operation - with nones in the middle") {
    ...
    val test_out = Map(
      false -> List((1.9,Some(1)), (2.0,None), (3.0,Some(4)), (3.0,None)),
      true -> List((1.5,Some(1)), (1.9,None), (3.0,Some(4)), (4.0,None),
        (5.0,Some(8)), (5.0,None)))
    out should be (test_out)
  }
}
